  ...
  return (
    <div className="grid md:grid-cols-2 gap-4">
      <Card title="Avatar Decoration">
        ...
        <button onClick={() => setTheme({ avatarDecoration: {} })} className="text-xs text-red-400 hover:text-red-300 self-start">Disable Avatar Decoration</button>
      </Card>
      <Card title="Gợi ý">
        <p className="text-sm text-zinc-400 leading-relaxed">Dán link ảnh PNG viền avatar (khung lửa, hoa, ngôi sao...) hoặc tải lên. Dùng thanh Hue Rotation để đổi màu khung cho hợp tone trang.</p>
      </Card>
    </div>
  )
}
